using Hub.Infrastructure.Architecture.Internacionalization.DocumentValidators;
using Hub.Infrastructure.Architecture.Internacionalization.Enums;
using System.Runtime.CompilerServices;

namespace Hub.Infrastructure.Architecture.Internacionalization
{
    /// <summary>
    /// Validates documents.
    /// </summary>
    public static class DocumentValidator
    {
        ...
        {
            string country = systemNumber.GetCountryCodeForNumber();
